#!/usr/bin/env bash
# Run BP-MulT baseline on MELD with 3 seeds (42, 3407, 2024) sequentially
# on 5 GPUs, then print mean ± std of Accuracy, Macro-F1, and Weighted-F1.
set -e

PROJ=/home/tahirahmad/Project_Code/CHADO_EMNLP
CFG=$PROJ/configs/meld/bpmult_meld.yaml
...
SEEDS=(42 3407 2024)
OUT_DIRS=(
  "$PROJ/experiments/results/meld/bpmult_seed42"
  "$PROJ/experiments/results/meld/bpmult_seed3407"
  "$PROJ/experiments/results/meld/bpmult_seed2024"
)
...
for i in 0 1 2; do
  ...
  echo ""
  echo "============================================================"
  echo "  MELD BP-MulT  seed=$SEED  →  $OUT"
  echo "============================================================"
...
echo ""
echo "============================================================"
echo "  BP-MulT MELD — 3-Seed Summary"
echo "============================================================"
python3 - <<'PYEOF'
...
seeds = [42, 3407, 2024]
dirs  = [
    "experiments/results/meld/bpmult_seed42",
    "experiments/results/meld/bpmult_seed3407",
    "experiments/results/meld/bpmult_seed2024",
]
